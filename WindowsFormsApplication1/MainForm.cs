...
namespace WindowsFormsApplication1
{
    public partial class MainForm : Form
    {
        ...
        public void AppendTextBox(string value)  // Receive Data (msg)
        {
            ...
            try
            {
                if (i >= 4)
                {
                    ...
                    if (valz == "0")
                    {
                        //MessageBox.Show(temporary_data2 +"=="+ temporary_data1);
                        temporary_data2 = temporary_data1;
                        //MessageBox.Show(global_var1);
                        Form2 f2 = new Form2();
                        f2.ShowDialog();
                        //global_var1 = "";
                    }
                    ...
                    //readThread.Resume();
                    //MessageBox.Show(Form2.global_var3);
        ...
        private void MainForm_Load(object sender, EventArgs e)// -========================= Main Form
        {
            ...
            webBrowser1.Navigate("fame.systems");
        }
        ...
        private void btn_edit_Click(object sender, EventArgs e) // ---------------> Edit Button
        {
            try
            {
                ...
                string validity = dataGridView1.Rows[index].Cells[7].Value.ToString();
            ...
            try
            {
                if (dataGridView1.Rows.Count > 0)
                {
                    ...
                    foreach (DataGridViewRow row in dataGridView1.Rows)
                    {
                        ...
                        string validity = dataGridView1.Rows[count].Cells[7].Value.ToString();
